...
/**
 * NovaApuracaoModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NovaApuracaoModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NovaApuracaoModel';
    ...
    {
        $this->setIfExists('xml_apuracao', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getXmlApuracao()
    {
        return $this->container['xml_apuracao'];
    }

    /**
     * Sets xml_apuracao
     *
     * @param string|null $xml_apuracao XML descrevendo a Apura�o enviada pelo contribuinte
     *
     * @return self
     */
    public function setXmlApuracao($xml_apuracao)
    {
        if (is_null($xml_apuracao)) {
            array_push($this->openAPINullablesSetToNull, 'xml_apuracao');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('xml_apuracao', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['xml_apuracao'] = $xml_apuracao;
