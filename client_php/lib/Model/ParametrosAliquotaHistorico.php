...
/**
 * ParametrosAliquotaHistorico Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ParametrosAliquotaHistorico implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParametrosAliquotaHistorico';
    ...
    {
        $this->setIfExists('aliq', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['aliq'];
    }

    /**
     * Sets aliq
     *
     * @param float|null $aliq aliq
     *
     * @return self
     */
    ...
    {
        if (is_null($aliq)) {
            throw new \InvalidArgumentException('non-nullable aliq cannot be null');
        }
        $this->container['aliq'] = $aliq;
