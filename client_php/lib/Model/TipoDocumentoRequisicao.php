...
/**
 * TipoDocumentoRequisicao Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class TipoDocumentoRequisicao
{
    ...
    public const PEDIDO_REGISTRO_EVENTO = 'PEDIDO_REGISTRO_EVENTO';
