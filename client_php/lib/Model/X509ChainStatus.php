...
/**
 * X509ChainStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class X509ChainStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'X509ChainStatus';
    ...
    protected static $openAPITypes = [
        'status' => '\OpenAPI\Client\Model\X509ChainStatusFlags',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'status_information' => 'setStatusInformation'
    ];
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'status_information' => 'getStatusInformation'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status_information', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\X509ChainStatusFlags|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\X509ChainStatusFlags|null $status status
     *
     * @return self
     */
    ...
    /**
     * Gets status_information
     *
     * @return string|null
     */
    public function getStatusInformation()
    {
        return $this->container['status_information'];
    }

    /**
     * Sets status_information
     *
     * @param string|null $status_information status_information
     *
     * @return self
     */
    public function setStatusInformation($status_information)
    {
        if (is_null($status_information)) {
            array_push($this->openAPINullablesSetToNull, 'status_information');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('status_information', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['status_information'] = $status_information;
