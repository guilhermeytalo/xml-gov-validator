 ...
 */
class KeySizes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeySizes';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('skip_size', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets skip_size
     *
     * @param int|null $skip_size skip_size
     *
     * @return self
     */
    public function setSkipSize($skip_size)
    {
        if (is_null($skip_size)) {
            throw new \InvalidArgumentException('non-nullable skip_size cannot be null');
        }
