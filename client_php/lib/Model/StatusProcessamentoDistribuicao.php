...
/**
 * StatusProcessamentoDistribuicao Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class StatusProcessamentoDistribuicao
{
    /**
    ...
    public const NENHUM_DOCUMENTO_LOCALIZADO = 'NENHUM_DOCUMENTO_LOCALIZADO';

    public const DOCUMENTOS_LOCALIZADOS = 'DOCUMENTOS_LOCALIZADOS';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::REJEICAO,
            self::NENHUM_DOCUMENTO_LOCALIZADO,
            self::DOCUMENTOS_LOCALIZADOS
        ];
    }
}
